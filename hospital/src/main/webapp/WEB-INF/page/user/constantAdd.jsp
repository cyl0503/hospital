...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">添加常数项</h3>
                    <form action="/constant/AddConstant" method="post">
                        常数项类型：<input type="text" name="constantid"><br>
                        常数项名称：<input type="text" name="constantitemname"><br>
