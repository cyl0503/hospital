    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">添加结算类型</h4> </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">添加结算类型</h3> ${msg}
                    <form action="/settleCategory/addSettleCategory" method="post" class="form-horizontal" role="form">
                        <div class="scdiv">
                            <label class="scLabel">结算类型名称：</label>
                            <input type="text" name="settlename">
                        </div>
                        <input id="scAdd" type="submit" value="添加">
                    </form>
                </div>
            </div>
        </div>
